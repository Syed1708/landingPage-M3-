...
<template>
    ...
    <section id="assignments" class="assignments">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2> {{ assignmentData[0].title }}</h2>
          <p>{{ assignmentData[0].description }}</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-blue">
              ...
              <h4><a href="">{{ assignmentData[1].assTitle }}</a></h4>
              <p>{{ assignmentData[1].assDes }}</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-md-0" data-aos="zoom-in"
            ...
            <div class="icon-box iconbox-orange ">
              ...
              <h4><a href="">{{ assignmentData[2].assTitle }}</a></h4>
              <p>{{ assignmentData[2].assDes }}</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in"
            ...
            <div class="icon-box iconbox-pink">
              ...
              <h4><a href="">{{ assignmentData[3].assTitle }}</a></h4>
              <p>{{ assignmentData[3].assDes }}</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="100">
            <div class="icon-box iconbox-yellow">
              ...
              <h4><a href="">{{ assignmentData[4].assTitle }}</a></h4>
              <p>{{ assignmentData[4].assDes }}</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
            <div class="icon-box iconbox-red">
              ...
              <h4><a href="">{{ assignmentData[5].assTitle }}</a></h4>
              <p>{{ assignmentData[5].assDes }}</p>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="300">
            <div class="icon-box iconbox-teal">
              ...
              <h4><a href="">{{ assignmentData[6].assTitle }}</a></h4>
              <p>{{ assignmentData[6].assDes }}</p>
            </div>
          </div>
    ...
    </section><!-- End assignments Section -->
</template>